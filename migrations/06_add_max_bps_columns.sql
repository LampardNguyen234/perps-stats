...
ADD COLUMN max_ask_bps DECIMAL(10,4) NULL;

-- Add max_bid_bps column (nullable for backward compatibility)  
ALTER TABLE liquidity_depth 
ADD COLUMN max_bid_bps DECIMAL(10,4) NULL;
...
CREATE INDEX idx_liquidity_depth_max_bps 
...
CREATE INDEX idx_liquidity_depth_ts_max_bps 
